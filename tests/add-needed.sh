...
../src/patchelf --add-needed libfoo0.so --add-needed libbar0.so ${SCRATCH}/simple
../src/patchelf --add-needed libfoo1.so,libfoo2.so,libfoo3.so ${SCRATCH}/simple
../src/patchelf --add-needed libbar1.so,libbar2.so,libbar3.so ${SCRATCH}/simple
